...
public class ListaDeReproduccion implements ListModel<String> {
	 ...
	 * @param pos1 posicion de un elemento de la lista
	 * @param pos2 posicion de otro elemento de la lista
	 */
	public void intercambia(int pos1, int pos2) {
		if(ficherosLista.get(pos1) != null && ficherosLista.get(pos2)!=null) {
	 ...
	 * @param f Fcihero a añadir
	 */
	public void add(File f) {
		ficherosLista.add(f);
	}
	/** Elimina el elemento de la posicion seleccionada.
	 * @param pos Posicion del elemento a quitar.
	 */
